    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('representative_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.representatives.index") }}" class="nav-link {{ request()->is("admin/representatives") || request()->is("admin/representatives/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-user-circle">

                            </i>
                            <p>
                                {{ trans('cruds.representative.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
                ...
                @can('basic_c_r_m_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/crm-statuses*") ? "menu-open" : "" }} {{ request()->is("admin/crm-notes*") ? "menu-open" : "" }} {{ request()->is("admin/crm-documents*") ? "menu-open" : "" }}">
                ...
                @endcan
                @can('setting_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/governorates*") ? "menu-open" : "" }} {{ request()->is("admin/cities*") ? "menu-open" : "" }} {{ request()->is("admin/post-statuses*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @endcan
                            @can('post_status_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.post-statuses.index") }}" class="nav-link {{ request()->is("admin/post-statuses") || request()->is("admin/post-statuses/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-bars">

                                        </i>
                                        <p>
                                            {{ trans('cruds.postStatus.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
