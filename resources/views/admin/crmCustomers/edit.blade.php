    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.crm-customers.update", [$crmCustomer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $crmCustomer->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('capital_default_price') ? 'is-invalid' : '' }}" type="number" name="capital_default_price" id="capital_default_price" value="{{ old('capital_default_price', $crmCustomer->capital_default_price) }}"  >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_default_price') ? 'is-invalid' : '' }}" type="number" name="other_default_price" id="other_default_price" value="{{ old('other_default_price', $crmCustomer->other_default_price) }}"  >
