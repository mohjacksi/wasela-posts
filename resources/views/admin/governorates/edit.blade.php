    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.governorates.update", [$governorate->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $governorate->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('default_price') ? 'is-invalid' : '' }}" type="number" name="default_price" id="default_price" value="{{ old('default_price', $governorate->default_price) }}"  >
